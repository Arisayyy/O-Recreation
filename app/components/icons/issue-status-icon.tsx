...
export function formatIssueStatusLabel(status: IssueStatusKey | string): string {
  switch (status) {
    case "backlog":
      return "Backlog";
    case "todo":
    ...
    default: {
      ...
      if (!s) return "Unknown";
      // best-effort: snake_case -> Title Case
      return s
        .split("_")
        .filter(Boolean)
...
export function IssueStatusIcon({
  ...
  status: IssueStatusKey | (string & {});
  className?: string;
}) {
  switch (status) {
    case "backlog":
      return <BacklogIcon className={className} />;
    case "todo":
      return <TodoIcon className={className} />;
    case "in_progress":
      return <InProgressIcon className={className} />;
    case "in_review":
      return <InReviewIcon className={className} />;
    case "done":
      return <DoneIcon className={className} />;
    case "canceled":
      return <CancelledIcon className={className} />;
    default:
      return <BacklogIcon className={className} />;
  }
}

function BacklogIcon({ className = "h-[14px] w-[14px]" }: { className?: string }) {
  return (
    <svg
      width="14"
      height="14"
...
function TodoIcon({ className = "h-[14px] w-[14px]" }: { className?: string }) {
  const color = "#e2e2e2";
  return (
    <svg
      aria-label="Todo"
...
function InProgressIcon({ className = "h-[14px] w-[14px]" }: { className?: string }) {
  const color = "lch(80% 90 85)";
  return (
    <svg
...
function InReviewIcon({ className = "h-[14px] w-[14px]" }: { className?: string }) {
  const color = "lch(60% 64.37 141.95)";
  return (
    <svg
...
function DoneIcon({ className = "h-[14px] w-[14px]" }: { className?: string }) {
  const color = "lch(70% 70 145)";
  return (
    <svg
      width="14"
      height="14"
...
function CancelledIcon({ className = "h-[14px] w-[14px]" }: { className?: string }) {
  const color = "#95a2b3";
  return (
    <svg
      width="14"
